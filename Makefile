...
matchedgen: tools/matchedgen.c $(GPS_CA_OBJ)
	${CC} ${CFLAGS} tools/matchedgen.c $(GPS_CA_OBJ) ${LDFLAGS} -o $@
...
x300tx: player/x300tx.cpp player/rtcm3_nav.o gpssim-lib.o $(GPS_CA_OBJ) gpssim.h
	${CXX} ${CXXFLAGS} -isystem . player/x300tx.cpp player/rtcm3_nav.o gpssim-lib.o $(GPS_CA_OBJ) ${UHD_LIBS} ${LDFLAGS} -o $@
...
test: jammergen matchedgen iqmix tests/test_parse_synth_revive tests/test_revive_transform tests/test_revive_scan tests/test_jammer_source tests/test_gps_ca
...
clean:
	rm -f gpssim.o gpssim-lib.o player/rtcm3_nav.o tools/jammer_source.o tools/gps_ca.o gps-sdr-sim jammergen matchedgen iqmix jammertx x300tx bladetx revive_candidates tests/test_parse_synth_revive tests/test_revive_transform tests/test_revive_scan tests/test_jammer_source tests/test_gps_ca *.bin .user-motion-size
