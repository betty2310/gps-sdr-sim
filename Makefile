...
revive_candidates: tools/revive_candidates.cpp player/rtcm3_nav.o gpssim-lib.o gpssim.h
	${CXX} -O3 -Wall -std=c++17 -isystem . tools/revive_candidates.cpp player/rtcm3_nav.o gpssim-lib.o ${LDFLAGS} -o $@
