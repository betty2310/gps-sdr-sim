...
// #define FLOAT_CARR_PHASE // For RKT simulation. Higher computational load,
// but smoother carrier phase.
...
#define SYNTH_REVIVE_DEFAULT_LOOKBACK_SEC 14400.0
#define SYNTH_REVIVE_MAX_LOOKBACK_SEC 28800.0
